...
public class BinarySearchTreeLabTest {
   ...
   static class BinarySearchTree<T extends Comparable<T>> {
      ...
      ///////////////////////////////////////////////////////////////////////////////
      public int depthLevel(Node root, T value, int level){
         if(root == null){
            return -1;    
         }                    
         ...
         int rLevel = depthLevel(root.left, value, level + 1);
         if(rLevel != -1) {
            return rLevel;
         }
         rLevel = depthLevel(root.right, value, level+1);
         return rLevel;
      }
      /**
      ...
      public int depth(T value) {
         return depthLevel(root,value, 1);
